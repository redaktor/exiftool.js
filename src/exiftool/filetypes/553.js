exports.info = { FormatID: '1341',
  ...
  FileFormatIdentifier: 
   [ { Identifier: 'application/vnd.ms-excel',
       IdentifierType: 'MIME' },
     { Identifier: 'fmt/553', IdentifierType: 'PUID' } ],
  Developers: 
   { DeveloperID: '93',
     DeveloperName: '',
  ...
  ExternalSignature: 
   { ExternalSignatureID: '1377',
     Signature: 'xlc',
     SignatureType: 'File extension' },
  InternalSignature: 
   { SignatureID: '874',
     SignatureName: 'BIFF 2 Chart',
     SignatureNote: 'BIFF2: BOF hex 0900. record length hex 0400, BIFF version (not used);filetype=chart=2000',
     ByteSequence: 
      { ByteSequenceID: '1098',
        ...
        Endianness: '',
        ByteSequenceValue: '09000400{2}2000' } },
  RelatedFormat: 
