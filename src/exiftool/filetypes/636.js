exports.info = { FormatID: '1436',
  FormatName: 'Microsoft PowerPoint Macro-Enabled Slide',
  FormatVersion: '2007',
  FormatAliases: '',
  FormatFamilies: '',
  ...
  FileFormatIdentifier: 
   [ { Identifier: 'application/vnd.ms-powerpoint.slide.macroEnabled.12',
       IdentifierType: 'MIME' },
     { Identifier: 'fmt/636', IdentifierType: 'PUID' } ],
  Developers: 
   { DeveloperID: '93',
     DeveloperName: '',
