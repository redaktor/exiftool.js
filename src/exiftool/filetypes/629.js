exports.info = { FormatID: '1428',
  FormatName: 'Microsoft PowerPoint Show',
  FormatVersion: '2007',
  FormatAliases: '',
  FormatFamilies: '',
  ...
  FileFormatIdentifier: 
   [ { Identifier: 'application/vnd.openxmlformats-officedocument.presentationml.slideshow',
       IdentifierType: 'MIME' },
     { Identifier: 'fmt/629', IdentifierType: 'PUID' } ],
  Developers: 
   { DeveloperID: '93',
     DeveloperName: '',
