exports.info = { FormatID: '917',
  FormatName: 'Kodak Digital Camera Raw Image File',
  FormatVersion: '',
  FormatAliases: '',
  FormatFamilies: '',
  FormatTypes: '',
  ...
  FileFormatIdentifier: { Identifier: 'fmt/192', IdentifierType: 'PUID' },
  ExternalSignature: 
   { ExternalSignatureID: '899',
     Signature: 'dcr',
