exports.info = { FormatID: '970',
  FormatName: 'Microsoft Office Binder File for Windows',
  ...
  FileFormatIdentifier: { Identifier: 'fmt/240', IdentifierType: 'PUID' },
  ExternalSignature: 
   { ExternalSignatureID: '970',
     Signature: 'obd',
