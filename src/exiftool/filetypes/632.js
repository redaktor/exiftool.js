exports.info = { FormatID: '1431',
  FormatName: 'Microsoft PowerPoint Macro-Enabled Template',
  FormatVersion: '2007',
  FormatAliases: '',
  FormatFamilies: '',
  ...
  FileFormatIdentifier: 
   [ { Identifier: 'application/vnd.ms-powerpoint.template.macroEnabled.12',
       IdentifierType: 'MIME' },
     { Identifier: 'fmt/632', IdentifierType: 'PUID' } ],
  Developers: 
   { DeveloperID: '93',
     DeveloperName: '',
