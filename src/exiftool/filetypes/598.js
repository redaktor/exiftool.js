exports.info = { FormatID: '1390',
  FormatName: 'Microsoft Excel Template',
  ...
  FileFormatIdentifier: 
   [ { Identifier: 'application/vnd.openxmlformats-officedocument.spreadsheetml.template',
       IdentifierType: 'MIME' },
     { Identifier: 'fmt/598', IdentifierType: 'PUID' } ],
  Developers: 
   { DeveloperID: '93',
     DeveloperName: '',
