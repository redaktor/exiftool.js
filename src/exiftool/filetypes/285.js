exports.info = { FormatID: '1025',
  ...
  FileFormatIdentifier: { Identifier: 'fmt/285', IdentifierType: 'PUID' },
  ExternalSignature: 
   [ { ExternalSignatureID: '1006',
       Signature: 'grb',
       SignatureType: 'File extension' },
     { ExternalSignatureID: '1012',
       Signature: 'wmo',
       SignatureType: 'File extension' } ],
  InternalSignature: 
   { SignatureID: '301',
     SignatureName: 'Gridded Binary 2.0',
     ...
     ByteSequence: 
      [ { ByteSequenceID: '401',
          ...
          Endianness: '',
          ByteSequenceValue: '47524942{3}02' },
        { ByteSequenceID: '402',
