exports.info = { FormatID: '920',
  FormatName: 'ERDAS IMAGINE Gray-scale Bitmap Image',
  FormatVersion: '',
  FormatAliases: '',
  FormatFamilies: '',
  ...
  FileFormatIdentifier: { Identifier: 'fmt/195', IdentifierType: 'PUID' },
  ExternalSignature: 
   { ExternalSignatureID: '902',
     Signature: 'gis',
