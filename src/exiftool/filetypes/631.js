exports.info = { FormatID: '1430',
  FormatName: 'Microsoft PowerPoint Template',
  FormatVersion: '2007',
  FormatAliases: '',
  FormatFamilies: '',
  ...
  FileFormatIdentifier: 
   [ { Identifier: 'application/vnd.openxmlformats-officedocument.presentationml.template',
       IdentifierType: 'MIME' },
     { Identifier: 'fmt/631', IdentifierType: 'PUID' } ],
  Developers: 
   { DeveloperID: '93',
     DeveloperName: '',
