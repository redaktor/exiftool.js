exports.info = { FormatID: '972',
  FormatName: 'Microsoft Office Binder Wizard for Windows',
  ...
  FileFormatIdentifier: { Identifier: 'fmt/242', IdentifierType: 'PUID' },
  ExternalSignature: 
   { ExternalSignatureID: '968',
     Signature: 'obz',
