exports.info = { FormatID: '927',
  FormatName: 'Nikon Digital SLR Camera Raw Image File',
  FormatVersion: '',
  FormatAliases: '',
  FormatFamilies: '',
  FormatTypes: '',
  ...
  FileFormatIdentifier: { Identifier: 'fmt/202', IdentifierType: 'PUID' },
  ExternalSignature: 
   { ExternalSignatureID: '910',
     Signature: 'nef',
