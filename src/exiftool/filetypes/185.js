exports.info = { FormatID: '906',
  FormatName: 'Prime OCR',
  FormatVersion: '3.9',
  FormatAliases: '',
  FormatFamilies: '',
  ...
  FileFormatIdentifier: { Identifier: 'fmt/185', IdentifierType: 'PUID' },
  ExternalSignature: 
   { ExternalSignatureID: '890',
     Signature: 'pro',
     SignatureType: 'File extension' },
  InternalSignature: 
   { SignatureID: '255',
     SignatureName: 'PrimeOCR 3.9',
     ...
     ByteSequence: 
      { ByteSequenceID: '327',
        ...
        ByteSequenceValue: '3339302C??2C{3}2C' } } }