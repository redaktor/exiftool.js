exports.info = { FormatID: '1427',
  FormatName: 'Microsoft Excel Macro-Enabled Add-In',
  FormatVersion: '2007',
  FormatAliases: '',
  FormatFamilies: '',
  ...
  FileFormatIdentifier: 
   [ { Identifier: 'application/vnd.ms-excel.addin.macroEnabled.12',
       IdentifierType: 'MIME' },
     { Identifier: 'fmt/628', IdentifierType: 'PUID' } ],
  Developers: 
   { DeveloperID: '93',
     DeveloperName: '',
