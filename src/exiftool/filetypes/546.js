exports.info = { FormatID: '1334',
  ...
  FileFormatIdentifier: { Identifier: 'fmt/546', IdentifierType: 'PUID' },
  Developers: 
   { DeveloperID: '56',
     DeveloperName: '',
  ...
  ExternalSignature: 
   { ExternalSignatureID: '1364',
     Signature: 'fh9',
     SignatureType: 'File extension' },
  InternalSignature: 
   { SignatureID: '865',
     SignatureName: 'FreeHand 9',
     SignatureNote: 'MAC File type code AGD4',
     ByteSequence: 
      { ByteSequenceID: '1089',
