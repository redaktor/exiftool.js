exports.info = { FormatID: '922',
  FormatName: 'InstallShield Compiled Rules File',
  FormatVersion: '',
  FormatAliases: '',
  FormatFamilies: '',
  FormatTypes: '',
  ...
  FileFormatIdentifier: { Identifier: 'fmt/197', IdentifierType: 'PUID' },
  ExternalSignature: 
   { ExternalSignatureID: '904',
     Signature: 'inx',
