exports.info = { FormatID: '1333',
  ...
  FileFormatIdentifier: { Identifier: 'fmt/545', IdentifierType: 'PUID' },
  Developers: 
   { DeveloperID: '56',
     DeveloperName: '',
  ...
  ExternalSignature: 
   { ExternalSignatureID: '1363',
     Signature: 'fh8',
     SignatureType: 'File extension' },
  InternalSignature: 
   { SignatureID: '864',
     SignatureName: 'FreeHand 8',
     SignatureNote: 'MAC File type Code AGD3',
     ByteSequence: 
      { ByteSequenceID: '1088',
