exports.info = { FormatID: '667',
  FormatName: 'JPEG File Interchange Format',
  FormatVersion: '1.00',
  FormatAliases: 'JFIF (1.00)',
  FormatFamilies: '',
  ...
  FileFormatIdentifier: 
   [ { Identifier: 'fmt/42', IdentifierType: 'PUID' },
  ...
  ExternalSignature: 
   [ { ExternalSignatureID: '563',
       Signature: 'jpeg',
       SignatureType: 'File extension' },
     { ExternalSignatureID: '571',
       Signature: 'jpe',
       SignatureType: 'File extension' },
     { ExternalSignatureID: '599',
       Signature: 'jpg',
       SignatureType: 'File extension' } ],
  InternalSignature: 
   { SignatureID: '66',
     SignatureName: 'JFIF 1.00',
     ...
     ByteSequence: 
      [ { ByteSequenceID: '168',
          ...
          Endianness: '',
          ByteSequenceValue: 'FFD8FFE0{2}4A464946000100(00|01|02)' },
        { ByteSequenceID: '169',
