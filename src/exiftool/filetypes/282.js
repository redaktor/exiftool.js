exports.info = { FormatID: '1022',
  FormatName: 'netCDF-3 Classic',
  FormatVersion: '',
  FormatAliases: '',
  FormatFamilies: '',
  FormatTypes: 'Dataset',
  ...
  FileFormatIdentifier: 
   [ { Identifier: 'application/netcdf', IdentifierType: 'MIME' },
     ...
     { Identifier: 'fmt/282', IdentifierType: 'PUID' } ],
  ExternalSignature: 
   [ { ExternalSignatureID: '1004',
       Signature: 'nc',
       SignatureType: 'File extension' },
     { ExternalSignatureID: '1005',
       Signature: 'cdf',
       SignatureType: 'File extension' } ],
  InternalSignature: 
   { SignatureID: '298',
     SignatureName: 'netCDF-3 Classic',
