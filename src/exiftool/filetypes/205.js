exports.info = { FormatID: '931',
  FormatName: 'Synchronized Multimedia Integration Language',
  FormatVersion: '',
  FormatAliases: '',
  FormatFamilies: '',
  ...
  FileFormatIdentifier: { Identifier: 'fmt/205', IdentifierType: 'PUID' },
  ExternalSignature: 
   { ExternalSignatureID: '913',
     Signature: 'smil',
