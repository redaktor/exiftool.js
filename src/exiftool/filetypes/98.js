exports.info = { FormatID: '640',
  ...
  FileFormatIdentifier: 
   [ { Identifier: 'fmt/98', IdentifierType: 'PUID' },
  ...
  Document: 
   { DocumentID: '27',
     DisplayText: 'World Wide Web Consortium, 1997, W3C Recommendation: HTML 3.2 Reference Specification',
     DocumentType: 'Authoritative',
     AvailabilityDescription: 'Public',
     AvailabilityNote: '',
     PublicationDate: '14 Jan 1997',
     TitleText: 'W3C Recommendation: HTML 3.2 Reference Specification',
     DocumentIPR: '',
     DocumentNote: '',
     DocumentIdentifier: 
      { Identifier: 'www.w3.org/TR/REC-html32',
        IdentifierType: 'URL' },
     Author: 
      { AuthorID: '106',
        AuthorName: '',
  ...
  ExternalSignature: 
   [ { ExternalSignatureID: '567',
       Signature: 'htm',
       SignatureType: 'File extension' },
     { ExternalSignatureID: '644',
       Signature: 'html',
       SignatureType: 'File extension' } ],
  InternalSignature: 
   { SignatureID: '36',
     SignatureName: 'HTML 3.2',
     SignatureNote: 'With DOCTYPE declaration of 3.2. Single byte sequence. BOF character sequence: {0-1024}<!(DOCTYPE|doctype) (HTML|html) (PUBLIC/public) "-//{1-16}//(DTD|dtd) {0-64}(HTML|html) 3.2',
     ByteSequence: 
      { ByteSequenceID: '278',
        ...
        Endianness: '',
        ByteSequenceValue: '3C21(444F4354595045|646F6374797065)20(48544D4C|68746D6C)20(5055424C4943|7075626C6963)20222D2F2F{1-16}2F2F(445444|647464)20{0-64}(48544D4C|68746D6C)20332E32' } },
  RelatedFormat: 
