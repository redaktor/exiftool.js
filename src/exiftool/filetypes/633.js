exports.info = { FormatID: '1432',
  FormatName: 'Microsoft PowerPoint Macro-Enabled Add-In',
  FormatVersion: '2007',
  FormatAliases: '',
  FormatFamilies: '',
  ...
  FileFormatIdentifier: 
   [ { Identifier: 'application/vnd.ms-powerpoint.addin.macroEnabled.12',
       IdentifierType: 'MIME' },
     { Identifier: 'fmt/633', IdentifierType: 'PUID' } ],
  Developers: 
   { DeveloperID: '93',
     DeveloperName: '',
