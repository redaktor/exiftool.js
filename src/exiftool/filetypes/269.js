exports.info = { FormatID: '1007',
  FormatName: 'Microsoft Works Database for Macintosh',
  FormatVersion: '4',
  FormatAliases: '',
  FormatFamilies: '',
  ...
  FileFormatIdentifier: { Identifier: 'fmt/269', IdentifierType: 'PUID' },
  ExternalSignature: 
   { ExternalSignatureID: '987',
     Signature: 'wdb',
