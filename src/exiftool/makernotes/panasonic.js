...
exports.ref = {
	...
	ShootingMode: function(n){ 
		return (n in exports.ref.shootingMode) ? {value: exports.ref.shootingMode[n], _val:n } : { value:n, _val:n }; 
	},
	Audio: {
		1: 'Yes',
		2: 'No',
	...
	*/
	...
	SceneMode: function(n){ 
		return (n in exports.ref.shootingMode) ? {value: exports.ref.shootingMode[n], _val:n } : { value:'Off', _val:n }; 
	},
