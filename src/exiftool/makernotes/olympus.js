...
exports.info = {
	...
	ref : {
		...
		*/
		...
		BodyFirmwareVersion: function(n){ return exports.info.ref.firmware(n); },
		LensFirmwareVersion: function(n){ return exports.info.ref.firmware(n); },
		ExtenderFirmwareVersion: function(n){ return exports.info.ref.firmware(n); },
		FlashFirmwareVersion: function(n){ return exports.info.ref.firmware(n); },
		MaxApertureAtMinFocal: function(n){ return exports.info.ref.aperture(n); },
		MaxApertureAtMaxFocal: function(n){ return exports.info.ref.aperture(n); },
		MaxAperture: function(n){ return exports.info.ref.aperture(n); },
		...
		FlashControlMode: function(arr){
			...
			return exports.info.ref.arr0(arr, flc);
        },
		
		FlashIntensity: function(arr){ return exports.info.ref.flashStrength(arr); },
		ManualFlashStrength: function(arr){ return exports.info.ref.flashStrength(arr); },
		...
		ContrastSetting: function(arr){ return exports.info.ref.minmax(arr); },
		SharpnessSetting: function(arr){ return exports.info.ref.minmax(arr); },
		...
		PictureModeSaturation: function(arr){ return exports.info.ref.minmax(arr); },
		PictureModeContrast: function(arr){ return exports.info.ref.minmax(arr); },
		PictureModeSharpness: function(arr){ return exports.info.ref.minmax(arr); },
		...
		ArtFilter: function(arr){ 
			return exports.info.ref.arr0(arr, exports.info.ref.filters);
		},
