...
exports.ref = {
	...
	ISOSetting: function(n){ return exports.ref.ISO(n); },
	...
	*/
	...
	ISOInfo: function(arr){ 
		var iso = {
			...
			0: { desc: 'ISO', fn: function(){ return exports.ref.ISOInfoISO(arr[0]) } }, 
			/*(val = 100 * 2**(raw/12-5))*/
			...
			6: { desc: 'ISO2', fn:function(){ return exports.ref.ISOInfoISO(arr[0]) } },
		...
		var flashData = { 
			1: { //100/101 - D2H, D2Hs, D2X, D2Xs, D50, D70, D70s, D80 and D200
				...
				6: { desc: 'ExternalFlashFirmware', fn: function(){ 
					...
					var ft = exports.ref.FlashFirmware
				...
				14: { desc: 'FlashGNDistance', values: (function(){ return exports.ref.FlashGNDistance })() },
				15: { desc: 'FlashGroupAControlMode', values: (function(){ return exports.ref.FlashControlMode })() },
				16: { desc: 'FlashGroupBControlMode', values: (function(){ return exports.ref.FlashControlMode })() },
			...
			2: { //102 - D40, D40x, D3 and D300
				...
				15: { desc: 'FlashGNDistance', values: (function(){ return exports.ref.FlashGNDistance })() },
